...
const _seedUsers = [
  ...
  { name: 'Eva',      pin: '6903', role: 'admin',   shift: null   },
  { name: 'Alexis',   pin: '6909', role: 'manager', shift: 'midi' },
  { name: 'Enola',    pin: '6911', role: 'staff',   shift: 'midi' },
  { name: 'Alan',     pin: '6919', role: 'staff',   shift: 'midi' },
  { name: 'François', pin: '6906', role: 'manager', shift: 'soir' },
  { name: 'Jules',    pin: '6910', role: 'manager', shift: 'soir' },
  { name: 'Jade',     pin: '6955', role: 'staff',   shift: 'soir' },
  { name: 'Lena',     pin: '6920', role: 'staff',   shift: 'soir' },
  { name: 'Sasha',    pin: '6950', role: 'staff',   shift: 'soir' },
  { name: 'Valentin', pin: '6907', role: 'staff',   shift: 'soir' },
  { name: 'Arthur',   pin: '6927', role: 'staff',   shift: 'soir' },
];
...
if (db.prepare('SELECT COUNT(*) as c FROM tasks').get().c === 0) {
  ...
  const seedList = [
    // ── MATIN - Mise en route ──
    ['matin', 'Mise en route', 'Allumages', 'Allumer caisse, plonge, fléchettes', 0],
    ['matin', 'Mise en route', 'Allumages', 'Allumer lumières intérieures + extérieures', 0],
    ['matin', 'Mise en route', 'Allumages', 'Allumer machine à café (remplir lait, café, chocolat, sucre)', 0],
    ['matin', 'Mise en route', 'Allumages', 'Vérifier que la clim soit sur le bon programme', 0],
    // ── MATIN - Mise en place salle ──
    ['matin', 'Salle', 'Mise en place', 'Mettre en place la salle (RDC + étage)', 0],
    ['matin', 'Salle', 'Mise en place', 'Sortir les panneaux', 0],
    ['matin', 'Salle', 'Mise en place', 'Mettre les cendriers sur les tables', 0],
    ['matin', 'Salle', 'Mise en place', 'Vérifier étage (toilettes, tables, mur à bière, coin canapé)', 0],
    // ── MATIN - Terrasse ──
    ['matin', 'Terrasse', 'Nettoyage terrasse', 'Balayer + sortir la terrasse', 0],
    ['matin', 'Terrasse', 'Nettoyage terrasse', 'Nettoyer et désinfecter tables et chaises de la terrasse', 0],
    // ── MATIN - Mise en place service ──
    ['matin', 'Service', 'Mise en place', 'Mettre les cartes sur les tables (vérifier propreté) + cartes boissons à l\'étage', 0],
    ['matin', 'Service', 'Mise en place', 'Nettoyer carte menu + carte boisson si besoin', 0],
    ['matin', 'Service', 'Mise en place', 'Linge', 0],
    ['matin', 'Service', 'Mise en place', 'Couvert + remplir étagères à côté cuisine (set de table, serviettes)', 0],
    ['matin', 'Service', 'Mise en place', 'Sauces', 0],
    ['matin', 'Service', 'Mise en place', 'Pailles à remettre en place', 0],
    ['matin', 'Service', 'Mise en place', 'Mise en place cocktail (coupes citron vert/jaune/orange/menthe, glaçons, sirops)', 0],
    ['matin', 'Service', 'Mise en place', 'Mise en place de la desserte', 0],
    ['matin', 'Service', 'Hygiène', 'Nettoyer porte d\'entrée', 0],
    ['matin', 'Service', 'Hygiène', 'Vérifier + nettoyer toilettes handicapé et classiques (papier, savon, gel nettoyant)', 0],

    // ── PASSATION - Après-midi ──
    ['passation', 'Après-midi', 'Mise en place', 'Couvert', 0],
    ['passation', 'Après-midi', 'Mise en place', 'Sauces', 0],
    ['passation', 'Après-midi', 'Mise en place', 'Étage / Toilettes', 0],
    ['passation', 'Après-midi', 'Mise en place', 'Retourner les panneaux', 0],
    ['passation', 'Après-midi', 'Mise en place', 'Vérifier cendriers', 0],
    ['passation', 'Après-midi', 'Mise en place', 'Carte tapas', 0],
    ['passation', 'Après-midi', 'Mise en place', 'Réservations', 0],
    ['passation', 'Après-midi', 'Mise en place bar soir', 'Mise en place bar pour le soir (glaçons, vider poubelles, sirops, coin cocktail)', 0],
    ['passation', 'Après-midi', 'Mise en place bar soir', 'Remonter cave', 0],
    ['passation', 'Après-midi', 'Clôture service midi', 'Pain', 0],
    ['passation', 'Après-midi', 'Clôture service midi', 'Gros débarrassage + plonge', 0],
    ['passation', 'Après-midi', 'Clôture service midi', 'Sortir la poubelle', 0],
    ['passation', 'Après-midi', 'Clôture service midi', 'Vider caisse vide', 0],

    // ── SOIR - Bar ──
    ['soir', 'Fermeture Bar', 'Nettoyage bar', 'Nettoyer plans de travail + frigo du bar', 0],
    ['soir', 'Fermeture Bar', 'Nettoyage bar', 'Nettoyer tapis de bar + plaque du bar', 0],
    ['soir', 'Fermeture Bar', 'Nettoyage bar', 'Nettoyer les murs à bière (éponger + becs)', 0],
    ['soir', 'Fermeture Bar', 'Nettoyage bar', 'Passer une tasse d\'eau chaude dans tous les becs des tireuses', 0],
    ['soir', 'Fermeture Bar', 'Nettoyage bar', 'Nettoyer sol sous les racks de pintes, sous l\'évier + sous poste cocktail', 0],
    ['soir', 'Fermeture Bar', 'Nettoyage bar', 'Nettoyer machine à café + écran caisse', 0],
    ['soir', 'Fermeture Bar', 'Cave & stocks', 'Faire les vides', 0],
    ['soir', 'Fermeture Bar', 'Cave & stocks', 'Vérifier la cave (btl consignées, fûts vides)', 0],
    ['soir', 'Fermeture Bar', 'Cave & stocks', 'Remplir sucre, sirop, pailles', 0],
    ['soir', 'Fermeture Bar', 'Cave & stocks', 'Changer btl Jäger si besoin', 0],
    ['soir', 'Fermeture Bar', 'Cave & stocks', 'Vérifier que les fûts vides soient bien sortis de la chambre froide', 0],
    ['soir', 'Fermeture Bar', 'Cave & stocks', 'Vérifier frigo verres soit allumé', 0],
    // ── SOIR - Salle ──
    ['soir', 'Fermeture Salle', 'Mobilier', 'Nettoyer l\'intégralité des tables', 0],
    ['soir', 'Fermeture Salle', 'Mobilier', 'Nettoyer les cendriers', 0],
    ['soir', 'Fermeture Salle', 'Mobilier', 'Retirer + regrouper cartes tapas des porte-menus + les nettoyer', 0],
    ['soir', 'Fermeture Salle', 'Mobilier', 'Remettre en place l\'espace canapé', 0],
    ['soir', 'Fermeture Salle', 'Mobilier', 'Ranger la salle du bas pour le ménage', 0],
    ['soir', 'Fermeture Terrasse', 'Terrasse', 'Nettoyer tables terrasses + ranger et chaîner les terrasses', 0],
    ['soir', 'Fermeture Terrasse', 'Terrasse', 'Rentrer les chaises', 0],
    ['soir', 'Fermeture Terrasse', 'Terrasse', 'Rentrer les panneaux (les poser sur les tables)', 0],
    ['soir', 'Fermeture Terrasse', 'Terrasse', 'Mettre les chaises sur les tables à l\'étage (vendredi + samedi)', 0],
    // ── SOIR - Fermeture bâtiment ──
    ['soir', 'Fermeture Bâtiment', 'Hygiène', 'Nettoyer les toilettes + remplir savon + papier toilette', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Vérifier que la cuisine soit éteinte + porte fermée + hotte éteinte', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Vérifier que l\'enseigne MOS sur bâche soit éteinte', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Vérifier que l\'economa soit fermé', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Vérifier les issues de secours', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Fermer toutes les fenêtres + éteindre les clim', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Remonter les bâches', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Fermer la porte du garage', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Éteindre les écrans du bar + télés (Apple TV)', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Éteindre les enceintes', 0],
    ['soir', 'Fermeture Bâtiment', 'Fermeture', 'Compter le pain et recommander si nécessaire', 0],
  ];
  seedList.forEach((t, i) => insertTask.run(t[0], t[1], t[2], t[3], i));
  db.exec('COMMIT');
}

// ─── Seed tâches nettoyage Bellecour ──────────────────────────────────────────
if (db.prepare("SELECT COUNT(*) as c FROM tasks WHERE category = 'nettoyage'").get().c === 0) {
  const insertNettoyage = db.prepare(
    'INSERT INTO tasks (category, section, subsection, description, task_order) VALUES (?, ?, ?, ?, ?)'
  );
  db.exec('BEGIN');
  const nettoyageTasks = [
    // ── QUOTIDIEN ──
    ['nettoyage', 'Quotidien', 'Quotidien', 'Nettoyer porte d\'entrée', 1],
    ['nettoyage', 'Quotidien', 'Quotidien', 'Propreté terrasse', 2],
    ['nettoyage', 'Quotidien', 'Quotidien', 'Commande coin cocktail', 3],
    ['nettoyage', 'Quotidien', 'Quotidien', 'Murs', 4],
    ['nettoyage', 'Quotidien', 'Quotidien', 'Nettoyer coin pain + desserte à côté porte entrée', 5],
    ['nettoyage', 'Quotidien', 'Quotidien', 'Nettoyer chaises/tabourets si besoin', 6],
    ['nettoyage', 'Quotidien', 'Quotidien', 'Nettoyer carte menu + boisson si besoin', 7],
    ['nettoyage', 'Quotidien', 'Quotidien', 'Nettoyer porte carte si besoin (Red Bull + Pago)', 8],
    // ── HEBDOMADAIRE ──
    ['nettoyage', 'Plan de Nettoyage', 'Lundi', 'Ménage de la salle', 1],
    ['nettoyage', 'Plan de Nettoyage', 'Lundi', 'Nettoyer escaliers', 2],
    ['nettoyage', 'Plan de Nettoyage', 'Mardi', 'Nettoyer portes', 1],
    ['nettoyage', 'Plan de Nettoyage', 'Mardi', 'Nettoyer verres à vin + étagères sous verres à vin', 2],
    ['nettoyage', 'Plan de Nettoyage', 'Mardi', 'Nettoyer descente escalier toilettes (mur, miroir, rambarde)', 3],
    ['nettoyage', 'Plan de Nettoyage', 'Mardi / Jeudi', 'Nettoyer cave', 1],
    ['nettoyage', 'Plan de Nettoyage', 'Mercredi', 'Nettoyer tasses à café', 1],
    ['nettoyage', 'Plan de Nettoyage', 'Mercredi', 'Nettoyer pieds de tables', 2],
    ['nettoyage', 'Plan de Nettoyage', 'Mercredi', 'Nettoyer faïence passe cuisine', 3],
    ['nettoyage', 'Plan de Nettoyage', 'Jeudi', 'Fenêtres + miroirs', 1],
    ['nettoyage', 'Plan de Nettoyage', 'Jeudi', 'Nettoyer porte menu', 2],
    ['nettoyage', 'Plan de Nettoyage', 'Vendredi', 'Nettoyer verres cocktail + étagère sous verres cocktail', 1],
    ['nettoyage', 'Plan de Nettoyage', 'Vendredi', 'Nettoyer contour du bar (faïence + plinthe)', 2],
    ['nettoyage', 'Plan de Nettoyage', 'Samedi', 'Frigos bar', 1],
    ['nettoyage', 'Plan de Nettoyage', 'Samedi', 'Piques fléchettes', 2],
    ['nettoyage', 'Plan de Nettoyage', 'Samedi', 'Murs (coin canapé, coin fléchette, grande mezzanine)', 3],
    ['nettoyage', 'Plan de Nettoyage', 'Dimanche', 'Nettoyer tapis', 1],
    ['nettoyage', 'Plan de Nettoyage', 'Dimanche', 'Panneaux', 2],
    ['nettoyage', 'Plan de Nettoyage', 'Dimanche', 'Ranger + nettoyer étagère sous la plonge', 3],
    ['nettoyage', 'Plan de Nettoyage', 'Dimanche', 'Vérifier verres + remonter si besoin', 4],
    ['nettoyage', 'Plan de Nettoyage', '1x par semaine', 'Balais sous poste cocktail + pinte', 1],
    ['nettoyage', 'Plan de Nettoyage', '1x par semaine', 'Nettoyer poste cocktail (bac à glaçon + évacuation + machine Jäger)', 2],
    ['nettoyage', 'Plan de Nettoyage', '1x par semaine', 'Filtre machine à glaçon + glace pilée', 3],
    // ── MENSUEL ──
    ['nettoyage', 'Plan de Nettoyage', '1x par mois', 'Banquettes', 1],
    ['nettoyage', 'Plan de Nettoyage', '1x par mois', 'Toiles d\'araignées (intérieur + extérieur)', 2],
    ['nettoyage', 'Plan de Nettoyage', '1x par mois', 'Vestiaire + couloir + local produits d\'entretien', 3],
    ['nettoyage', 'Plan de Nettoyage', '1x par mois', 'Chewing-gum (sous tables, chaises, bar, sol)', 4],
    ['nettoyage', 'Plan de Nettoyage', '1x par mois', 'Nettoyer entièrement machine à glaçon + glace pilée', 5],
    ['nettoyage', 'Plan de Nettoyage', '1x par mois', 'Mettre canard WC dans évacuation bière', 6],
    ['nettoyage', 'Plan de Nettoyage', '1x par mois', 'Nettoyer étagères côté alcool', 7],
  ];
  for (const t of nettoyageTasks) insertNettoyage.run(t[0], t[1], t[2], t[3], t[4]);
  db.exec('COMMIT');
  console.log(`✅ Seed : ${nettoyageTasks.length} tâches NETTOYAGE Bellecour ajoutées`);
}
